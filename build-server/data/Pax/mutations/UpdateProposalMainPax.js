...
var props = {
  mainPaxKey: { type: _graphql.GraphQLString },
      ...
      return _regenerator2.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return paxCtrl.updateProposalMainPax(inputFields);

            case 2:
              mainPaxKey = _context.sent;
              return _context.abrupt('return', mainPaxKey);
