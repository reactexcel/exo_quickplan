...
var _TripPassenger = require('./../types/TripPassenger');
...
var props = {
  travelCompany: { type: _graphql.GraphQLString },
  travelAgent: { type: _graphql.GraphQLString },
  leadCustomer: { type: _graphql.GraphQLString },
  startDate: { type: _graphql.GraphQLString },
  tripDuration: { type: _graphql.GraphQLInt },
...
exports.default = (0, _graphqlRelay.mutationWithClientMutationId)({
  ...
  inputFields: (0, _extends3.default)({}, props, {
    mainPAX: { type: _TripPassenger.PassengerInputType }
  }),
  outputFields: (0, _extends3.default)({}, props, {
    mainPAX: { type: _TripPassenger.PassengerOutputType }
  }),
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              return _context.abrupt('return', tripCtrl.getTrip(saveDoc));
