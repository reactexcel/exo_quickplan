...
exports.default = (0, _graphqlRelay.mutationWithClientMutationId)({
  ...
  inputFields: {
    ...
    serviceIndex: { type: _graphql.GraphQLString },
    remark: { type: _graphql.GraphQLString }
  },
  outputFields: {
    trips: {
      type: _Trip3.default,
  ...
  mutateAndGetPayload: function () {
    var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(_ref2) {
      var tripKey = _ref2.tripKey,
          ...
          serviceIndex = _ref2.serviceIndex,
          remark = _ref2.remark;
      var trip, service;
      return _regenerator2.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              trip = _context.sent;
              service = trip.countryBookings[countryIndex].cities[cityIndex].serviceBookings[serviceIndex];
