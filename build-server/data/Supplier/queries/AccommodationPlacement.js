...
var supplierController = _interopRequireWildcard(_Supplier);

var _AccommodationPlacement = require('../types/AccommodationPlacement');
...
exports.default = {
  accommodationPlacement: {
    type: _AccommodationPlacement2.default,
    args: {
        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return supplierController.getAccommodationPlacement(args);
