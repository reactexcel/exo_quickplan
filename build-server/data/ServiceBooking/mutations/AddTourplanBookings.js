...
var props = {
  serviceBookingKeys: { type: new _graphql.GraphQLList(_graphql.GraphQLID) }
};
...
exports.default = (0, _graphqlRelay.mutationWithClientMutationId)({
  ...
  outputFields: {
    serviceBookings: {
      type: new _graphql.GraphQLList(_ServiceBooking3.default),
      ...
      return _regenerator2.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return servicebookingCtrl.addTourplanBookings((0, _extends3.default)({}, inputFields));
